...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PAIN_SPLIT, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AURORA_BEAM, MOVE_PROTECT, MOVE_FACADE, MOVE_ICY_WIND}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BODY_SLAM, MOVE_THUNDERBOLT, MOVE_SURF, MOVE_SECRET_POWER}
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_TWISTER}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_HORN_DRILL, MOVE_RAIN_DANCE, MOVE_FURY_ATTACK}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Cogita[] = {
    {
    .iv = 100,
    .lvl = 40,
    .species = SPECIES_AZUMARILL,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .species = SPECIES_LOTAD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_RAIN_DANCE, MOVE_PROTECT, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_SEALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_AURORA_BEAM, MOVE_BODY_SLAM, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HORN_DRILL, MOVE_RAIN_DANCE, MOVE_MEGAHORN, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_AMNESIA, MOVE_EARTHQUAKE, MOVE_RAIN_DANCE, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_TWISTER, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_LOMBRE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_RAIN_DANCE, MOVE_PROTECT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BODY_SLAM, MOVE_AURORA_BEAM, MOVE_EARTHQUAKE, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    ...
    .moves = {MOVE_HYPER_BEAM, MOVE_AERIAL_ACE, MOVE_WATER_PULSE, MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Blue[] = {
    ...
    .moves = {MOVE_RECOVER, MOVE_PSYCHIC, MOVE_FUTURE_SIGHT, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 79,
