const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_LEADER_JUAN_FINAL] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_JUAN_FINAL, gTrainerFrontPic_LeaderJuanFinal, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(LEADER_JUAN_FINAL, gTrainerPalette_LeaderJuan),
